...
class Auth_Ldap {
    ...
    function login($username, $password) {
        ...
        //check attibute from ldap compare to $config['role']
    ...
    private function _authenticate($username, $password) {
        ...
        $bind = ldap_bind($this->ldapconn, $binddn, $password); // add @
        if(!$bind) {
    ...
    private function _get_role($username) {
        ...
        $search = @ldap_search($this->ldapconn, $this->basedn, $filter, array('cn')); //add @
        if(! $search ) {
