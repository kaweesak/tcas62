		...
		<div class="row">
            <div class="col-lg-8">
						<section id="description">
							<h4>รายละเอียด</h4>
                            <img class="img-fluid" src="<?php echo base_url();?>uploads/tcas62/tcas4.jpg" alt="admission" style="padding-bottom:20px">
						<!-- 	<div class="row">
...
<div class="video-responsive">
                            ...
                            <br>
                             <a href="<?php echo base_url();?>uploads/files/admission.pdf" class="btn_1 full-width outline wishlist" target="_blank">หลักเกณฑ์การรับสมัครบุคคลเข้าศึกษา และหลักสูตรที่เปิดรับ</a>
                        ...
                        <div class="card-body">
                           <?php foreach ($tcass as $key => $r2){ 
                               if($r2->fac_id == $r->fac_id){ ?>                               	
			                        ...
			                        <a  href="<?php echo base_url('uploads/tcas62/4/0'.$r2->fac_id .'/'. $r2->c_id.'.pdf');?>" target="_blank"> <?php echo $r2->c_name . (!isset($r2->loc) || $r2->loc=='' ? '':'('.$r2->loc.')'); ?> </a><span class="badge badge-success float-right"><?php echo $r2->t_q4; ?></span><br>
