...
<head>
    ...
    <meta property="og:description"  content="พยาบาลศาสตร์, การศึกษาปฐมวัย, การประถมศึกษา ,เทคโนโลยีอาหาร,ธุรกิจการบิน ,การท่องเที่ยว ,TCAS 62, สมัครเรียนมหาวิทยาลัยสวนดุสิต "/>
...
<body>
	...
	<header class="header menu_fixed">
		...
		<a href="<?php echo base_url();?>" title="TCAS - Suan Dusit University">
				<img src="<?php echo base_url();?>uploads/img/logo.png" width="150" height="36" data-retina="true" alt="มหาวิทยาลัยสวนดุสิต" class="logo_normal">
