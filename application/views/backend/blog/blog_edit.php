            ...
            <div class="container-fluid">
                ...
                <div class="row">
                     ...
                     <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">	
                                <h5 class="card-title text-uppercase">BLOG DETAILS</h5>                               
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label class="col-md-12" for="example-text">Excerpt</span>
                                            </label>
                                            <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label class="col-md-12" for="example-text">Content</span>
                                            </label>
                                            <div class="col-md-12">
                                                <input type="text" id="example-text" name="example-text" class="form-control" placeholder="time span of the course">
                                            </div>
                     ...
                     <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                        <div class="row">
                                            <label class="col-sm-12">Freture Image</label>
                                            <div class="col-sm-12">
