...
class Tcas_model extends CI_Model
{
    ...
    public function get_tcas_data()
    {       
        $query = $this->db->get('tbl_tcas');
        return $query->result();
    }
 ...
 public function get_events_by_round($limit)
    {
        $this->db->order_by('event_order', 'ASC');
        $query = $this->db->get_where('tbl_tcas_events', array('tcas_id' => $limit));
        return $query->result();
    }
